...
Weekly challenges (games) with others. Join or create a game, maybe invite
 ...
 or collective impact you can make. Same with Giving Games.
...
- max 1 private game and 1 public game per week
  ...
  - scarcity, moderation; prevent overload 
    - thus only 2 of growth, giving can be done per week
...
"Gifts" becomes the longer term goals equivalent and the app is
 basically 2 things - daily / weekly lifestyle / habit growth and giving
 and then longer term growth & giving achievements. But
...
"Luke is doing Growth Games this week and would like to play with /
...
Pre-seed with challenges in each of the 2 categories (random acts of
...
Track the "biggest possible growth / giving" impact each week
 ...
 possible completions. So show "35 growths / gives" on the
 leaderboard if get 100% of them, 30 if miss 5, etc.

Individual "Grower / Giver of the Week" for each Game Group. Show these on
 All Games home page as well as individual champs.
