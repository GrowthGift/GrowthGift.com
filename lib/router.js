...
Router.configure({
  ...
  waitOn: function () {
    return [
      ...
      // Can not put this here. If we do, then if a user joins a game or data
      // otherwise updates, it will not be reflected.. // TODO - fix - should
      // be able to subscribe ONCE and then only on UPDATES.. not on page
      // reloads..
